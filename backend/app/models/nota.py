...
class Nota(Base):
    ...
    trimestre1: Mapped[float | None] = mapped_column(Numeric(4, 2))
    trimestre2: Mapped[float | None] = mapped_column(Numeric(4, 2))
    trimestre3: Mapped[float | None] = mapped_column(Numeric(4, 2))
    total: Mapped[float | None] = mapped_column(Numeric(4, 2))
